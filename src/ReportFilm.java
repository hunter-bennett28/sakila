...
public class ReportFilm extends JPanel implements SakilaTab {
	...
	public ReportFilm(SakilaHome home)
	{
		...
		searchPanel.add(new JLabel("Search Database", JLabel.CENTER), BorderLayout.PAGE_START);
		...
		btnSearch.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				ResultSet rs=home.controller.getReport(category, startDate, endDate, storeId);
